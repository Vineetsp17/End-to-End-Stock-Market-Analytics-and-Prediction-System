...
ALPHA_KEY = "ROZ9MAFIIE21DMZN"
MARKETSTACK_KEY = "7d55f9a554cff8850d7a24207e53a942"
FINNHUB_KEY = "d7r4kghr01qtpsm11tl0d7r4kghr01qtpsm11tlg"
...
def fetch_stock_data(symbol="AAPL"):
    ...
    save_path = os.path.join(BASE_DIR, "data", "raw_stock_data.csv")
